            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <h4><img src="assets/images/svg/newspapercolour.svg" class="rounded" style="width: 35px"> BERITA TERBARU</h4>
                        </div>
                        ...
                        <div class="col-md-12 mb-3 mt-4">
                            <h4><img src="assets/images/svg/photocolour.svg" class="rounded" style="width: 35px"> FOTO TERBARU</h4>
                        </div>
                        ...
                        <!-- video section -->
                        <div class="col-md-12 mb-3 mt-4">
                            <h4><img src="assets/images/svg/video-cameracolour.svg" class="rounded" style="width: 35px"> VIDEO TERBARU</h4>
                        </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="title mb-4 mt-5">
                        <h4><img src="assets/images/svg/link.svg" class="rounded" style="width: 35px"> KATEGORI BERITA</h4>
                    </div>
