    ...
    <div class="post-index">
        ...
        <header class="pt-5 border-bottom bg-light">
            <div class="container pt-md-1 pb-md-1">
                <h1 class="bd-title mt-4 font-weight-bold"><img src="assets/images/svg/photocolour.svg" class="rounded" style="width: 35px"> GALERI FOTO</h1>
                <p class="bd-lead">Galeri Foto terbaru tentang Kecamatan Lolayan</p>
            </div>
        </header>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><router-link :to="{ name: 'photo' }" class="text-decoration-none"> Galeri Foto</router-link></li>
        </ol>
        </nav>
        <!-- end breadcrumb -->
