    ...
    <div class="post-index">
        ...
        <header class="pt-5 border-bottom bg-light">
            <div class="container pt-md-1 pb-md-1">
                <h1 class="bd-title mt-4 font-weight-bold"><img src="assets/images/svg/newspapercolour.svg" class="rounded" style="width: 35px"> BERITA
                </h1>
                <p class="bd-lead">Berita terbaru tentang Kecamatan Lolayan</p>
            </div>
        </header>
