    ...
    <div class="video">
        ...
        <header class="pt-5 border-bottom bg-light">
            <div class="container pt-md-1 pb-md-1">
                <h1 class="bd-title mt-4 font-weight-bold"><img src="assets/images/svg/video-cameracolour.svg" class="rounded" style="width: 35px"> VIDEO</h1>
                <p class="bd-lead">Galeri Video terbaru tentang Kecamatan Lolayan</p>
            </div>
        </header>
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><router-link :to="{ name: 'home' }" class="text-decoration-none"><i class="fa fa-home"></i> Beranda</router-link></li>
            <li class="breadcrumb-item"><router-link :to="{ name: 'video' }" class="text-decoration-none"> Galeri Video</router-link></li>
        </ol>
        </nav>
        <!-- end breadcrumb -->
