    ...
    <div class="post-index">
        ...
        <header class="pt-5 border-bottom bg-light">
            <div class="container pt-md-1 pb-md-1">
                <h1 class="bd-title mt-4 font-weight-bold"><i class="fas fa-phone-alt" aria-hidden="true"></i> KONTAK</h1>
                <p class="bd-lead">Hubungi Kami</p>
            </div>
        </header>
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><router-link :to="{ name: 'contact' }" class="text-decoration-none"><i class="fas fa-phone-alt"></i> Kontak</router-link></li>
        </ol>
        </nav>
        <!-- end breadcrumb -->
                ...
                <div class="col-md-5">
                    <div class="card border-0 shadow-sm rounded">
                        <div class="card-body">
                            ...
                            <hr>
                            <p>
                                <i class="fa fa-map-marker" aria-hidden="true"></i> Jl. xxx
                                <br>
                                <br>
                                <i class="fas fa-phone-alt"></i> +62853-1234-5678
                                <br>
                                <br>
                                <i class="fas fa-envelope"></i> info@indonesia.ac.id
                            </p>
                        </div>
                    </div>
                </div>
