    ...
    <div class="post-index">
        ...
        <header class="pt-5 border-bottom bg-light">
            <div class="container pt-md-1 pb-md-1">
                <h1 class="bd-title mt-4 font-weight-bold"><img src="assets/images/svg/calendarcolour.svg" class="rounded" style="width: 35px"> AGENDA</h1>
                <p class="bd-lead">Agenda terbaru tentang Kecamatan Lolayan</p>
            </div>
        </header>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <router-link :to="{ name: 'event' }" class="text-decoration-none"> Agenda
                    </router-link>
                </li>
            </ol>
        </nav>
